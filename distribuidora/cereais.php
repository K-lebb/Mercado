...
<div class="dropdown">
    ...
    <div class="product-price-container">
        ...
        <button type="button" class="button-hover-background" onclick="adicionarAoCarrinho('Arroz', 5.00)">
            <img src="https://cdn-icons-png.flaticon.com/128/34/34627.png" alt="cart-icon">
        </button>
        <p>Quantidade</p>
        <?php
        include_once ("../verificar/conexao.php");
        $sql = "SELECT quantidade, id_duplicatas, id FROM produtos WHERE id_duplicatas = 3";
...
<div class="product-card">
    ...
    <div class="product-price-container">
        ...
        <button type="button" class="button-hover-background" onclick="adicionarAoCarrinho('Aveia', 8.00)">
            <img src="https://cdn-icons-png.flaticon.com/128/34/34627.png" alt="cart-icon">
        </button>
        <p>Quantidade</p>
        <?php
...
<div class="product-card">
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRlaycbm_Ws0rsd1MGvyEyVLdwy37G0Q6f-Fw&s" alt="Produto 2" height="300" width="300px" class="product-image">
    <strong class="product-title">Floco de Milho</strong>
    <p>Flocos de Milho Dona Clara</p>
    <div class="product-price-container">
        <span class="product-price">R$ 5,00</span>
        <button type="button" class="button-hover-background" onclick="adicionarAoCarrinho('Flocos de Milho', 5.00)">
            <img src="https://cdn-icons-png.flaticon.com/128/34/34627.png" alt="cart-icon">
        </button>
        <p>Quantidade</p>
...
<div class="product-card">
    ...
    <div class="product-price-container">
        ...
        <button type="button" class="button-hover-background" onclick="adicionarAoCarrinho('Soja', 12.00)">
            <img src="https://cdn-icons-png.flaticon.com/128/34/34627.png" alt="cart-icon">
        </button>
        <p>Quantidade</p>
        <?php
