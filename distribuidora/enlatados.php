...
<div class="dropdown">
    ...
    <div class="product-price-container">
        ...
        <button type="button" class="button-hover-background" onclick="adicionarAoCarrinho('Sardinha', 5.00)">
            <img src="https://cdn-icons-png.flaticon.com/128/34/34627.png" alt="cart-icon">
        </button>
        <p>Quantidade</p>
        <?php
        include_once ("../verificar/conexao.php");
        $sql = "SELECT quantidade, id_duplicatas, id FROM produtos WHERE id_duplicatas = 4";
...
<div class="product-card">
    ...
    <div class="product-price-container">
        ...
        <button type="button" class="button-hover-background" onclick="adicionarAoCarrinho('Atum', 10.00)">
            <img src="https://cdn-icons-png.flaticon.com/128/34/34627.png" alt="cart-icon">
        </button>
        <p>Quantidade</p>
        <?php
...
<div class="product-card">
    <img src="https://images-americanas.b2w.io/produtos/7460468695/imagens/carne-bovina-fiambre-bordon-lata-320g/7460468695_1_xlarge.jpg" alt="Produto 2" height="300" width="300px" class="product-image">
    <strong class="product-title">Carne de Lata</strong>
    <p>Carne de Lata Bordon</p>
    <div class="product-price-container">
        <span class="product-price">R$ 8,00</span>
        <button type="button" class="button-hover-background" onclick="adicionarAoCarrinho('Carne de Lata', 8.00)">
            <img src="https://cdn-icons-png.flaticon.com/128/34/34627.png" alt="cart-icon">
        </button>
        <p>Quantidade</p>
        <?php
...
<div class="product-card">
    <img src="https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcSKv2MEccmVLQQx3jUUxfxWZsHa8YzcDXrW0S8OoLtvOdKpFCBi2xmVTcSbRMvHxjJvLYF7W3vQcHvb22lMKNZ5soaUuDZF0EpBEOPF9Owa&usqp=CAE" alt="Produto 3" height="300" width="300px" class="product-image">
    <strong class="product-title">Feijoada na Lata</strong>
    <p>Feijoada na Lata Bordon</p>
    <div class="product-price-container">
        <span class="product-price">R$ 9,00</span>
        <button type="button" class="button-hover-background" onclick="adicionarAoCarrinho('Feijoada na Lata', 9.00)">
            <img src="https://cdn-icons-png.flaticon.com/128/34/34627.png" alt="cart-icon">
        </button>
        <p>Quantidade</p>
        <?php
...
<div class="product-card">
    <img src="https://http2.mlstatic.com/D_NQ_NP_912156-MLB71753957350_092023-O.webp" alt="Produto 3" height="300" width="300px" class="product-image">
    <strong class="product-title">Almôndegas</strong>
    <p>Almôndegas Oderich</p>
    <div class="product-price-container">
        <span class="product-price">R$ 10,00</span>
        <button type="button" class="button-hover-background" onclick="adicionarAoCarrinho('Almôndegas', 10.00)">
            <img src="https://cdn-icons-png.flaticon.com/128/34/34627.png" alt="cart-icon">
        </button>
        <p>Quantidade</p>
        <?php
