...
<div class="dropdown">
    ...
    <div class="product-card">
        ...
        <div class="product-price-container">
            ...
            <button type="button" class="button-hover-background" onclick="adicionarAoCarrinho('Leite', 5.00)"><img src="https://cdn-icons-png.flaticon.com/128/34/34627.png" alt="cart-icon"></button>
        </div>
    </div>
    ...
    <div class="product-card">
        ...
        <div class="product-price-container">
            <span class="product-price">R$ 5,00</span>
            <button type="button" class="button-hover-background" onclick="adicionarAoCarrinho('BatGut', 5.00)"><img src="https://cdn-icons-png.flaticon.com/128/34/34627.png" alt="cart-icon"></button>
        </div>
    </div>

    <!-- Continue adding other product cards in the same format -->
    ...
    <div class="product-card">
        ...
        <div class="product-price-container">
            <span class="product-price">R$ 5,00</span>
            <button type="button" class="button-hover-background" onclick="adicionarAoCarrinho('Nata', 5.00)"><img src="https://cdn-icons-png.flaticon.com/128/34/34627.png" alt="cart-icon"></button>
        </div>
    </div>
    ...
    <div class="product-card">
        ...
        <div class="product-price-container">
            ...
            <button type="button" class="button-hover-background" onclick="adicionarAoCarrinho('Margarina', 8.00)"><img src="https://cdn-icons-png.flaticon.com/128/34/34627.png" alt="cart-icon"></button>
        </div>
    </div>
    ...
    <div class="product-card">
        ...
        <div class="product-price-container">
            <span class="product-price">R$ 5,00</span>
            <button type="button" class="button-hover-background" onclick="adicionarAoCarrinho('Requeijão', 5.00)"><img src="https://cdn-icons-png.flaticon.com/128/34/34627.png" alt="cart-icon"></button>
        </div>
    </div>
</div>
